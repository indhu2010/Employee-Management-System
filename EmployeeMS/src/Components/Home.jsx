...
const Home = () => {
  ...
  // to fetch the data using useEffecthook()
  useEffect(() => {
    adminCount();
    employeeCount();
    salaryCount();
  ...
  return (
    <div>
      <div className="p-3 d-flex justify-content-around mt-3">
        <div className="px-3 pt-2 pb-3 border border-danger shadow-sm w-25">
        ...
        <div className="px-3 pt-2 pb-3 border border-success shadow-sm w-25">
          <div className="text-center pb-1">
            <h4>Employee</h4>
          </div>
          <hr />
        ...
        <div className="px-3 pt-2 pb-3 border border-primary shadow-sm w-25">
          <div className="text-center pb-1">
            <h4>Salary</h4>
          </div>
          <hr />
